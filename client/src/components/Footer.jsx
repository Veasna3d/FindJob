      ...
      <div className="bg-[#1d4ed8]">
              ...
              <div className="w-auto px-4 " key={id + title}>
                ...
                <div className="mb-10 flex flex-col gap-3">
                  {links.map((link, indexedDB) => (
                    <Link key={link} to="/" className="text-gray-300 hover:text-white">
                      {link}
                    </Link>
                  ))}
                </div>
        ...
        <div className="">
          ...
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between">
            <div className="w-full mb:w-2/4 lg:-w-1/3 h-16 flex items-center justify-center md:justify-start">
              <TextInput
                styles="w-full flex-grow md:w-40 2xl:w-64 bg-gray-100 sm:mr-4 mb-2"
                type="email"
        ...
        <div className="bg-[#001a36]">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-300 text-sm text-center sm:text-left">
              ...
              <a
                href="https://youtube.com/@veasnapen"
